import 'package:datemarker/conformation.dart';
...
class _DatePageState extends State<DatePage> {
  ...
  String url = 'http://10.0.2.2:5000/ppi?Query=cwkmBhKrA6s';
                  ...
                  child: Row(
                    children: [
                      ElevatedButton(
                        ...
                        onPressed: () {
                          setState(() {
                            url = 'http://10.0.2.2:5000/ppi?Query='+widget.link;
                          });
                        },
                      ),
                      ElevatedButton(
